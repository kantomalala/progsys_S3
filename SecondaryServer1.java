...
public class SecondaryServer1 {
    ...
    public SecondaryServer1() {
        this.port = 5001;  // Port prédéfini
        this.storagePath = "storage/secondary1";  // Chemin prédéfini
